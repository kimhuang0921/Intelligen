...
spec AllRefClkPins10ns_diff_wvt {
    ...
    setup digInOut pad_top_d2ds_phy2_refclk100_p + pad_top_d2ds_phy4_refclk100_p + pad_pcie1_refclk100_1_p + pad_pcie1_refclk100_0_p + pad_pcie0_refclk100_3_p + pad_pcie0_refclk100_0_p + pad_pcie1_refclk100_3_p + pad_ams_pdp_1_pad_refclk_p + pad_pcie1_refclk100_2_p + pad_top_d2ds_phy3_refclk100_p + pad_ams_pdp_0_pad_refclk_p + pad_top_d2ds_phy0_refclk100_p + pad_pcie0_refclk100_1_p + pad_top_d2ds_phy1_refclk100_p + pad_refclk_100_spare_p + pad_refclk_100_p + pad_pcie0_refclk100_2_p {
        wavetable AllRefClkPins10ns_wvt {
            xModes=1;
            0 : d1:0;
            1 : d1:1 d2:0;
